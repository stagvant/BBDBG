...
procrw(0x0207B837,BB106M,1,1);
procrw(0x00FB9625,BB106N,1,1);
procrw(0x00FB9635,BB106O,1,1);
procrw(0x0201D409,BB106P,1,1);
procrw(0x01D9E0D3,BB106Q,1,1);
procrw(0x00F71BDD,BB106R,1,1);
procrw(0x022A524B,BB106S,1,1);}}}
scePthreadExit(NULL);
return NULL;}
